            ...
            <div class="col-md-12 no-padding-lr sear-result-column">
              <div class="latest-job article-row1">
                ...
                <div class="col-md-10 no-padding-lr">
                  <div class="col-md-8 col-sm-8 col-xs-8 no-padding-lr job-status resp-grid1 job-status-3"> <span class="per-name grey-color"><a href="<?php echo esc_url(get_permalink()); ?>">
                    <?php the_title(); ?>
                    </a></span> </div>
                  ...
                  <div class="col-md-12 no-padding-lr">
                    <div class="job-btn-group late-job-btn clearfix"> <?php echo get_the_category_list( __( ', ', 'jobile' ), '', '' ); ?> <span class="jobile-tag-list"><?php echo get_the_tag_list( '', __( ' ', 'jobile' ) );?></span> </div>
                  </div>
                  <div class="col-md-12 no-padding-lr">
                    <p class="result-btm-text">
                      <?php the_excerpt(); ?>
                      <a href="<?php echo esc_url(get_permalink()); ?>" class="color-068587">
                      <?php _e('Read More', 'jobile') ?>
                      </a></p>
                  </div>
                </div>
              </div>
